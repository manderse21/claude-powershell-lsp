...
# measure.ps1 -- publication evidence set for dispatch 000267 (freeze 1B),
...
function Get-HeadStamp {
    ...
    $h = & git -C 'C:\Users\mande\projects\work\nortam\claude-powershell-lsp' rev-parse origin/main
...
function Fetch-Thing {
    param([string]$Name)
    # warm-path timing fixture -- one PSUseApprovedVerbs finding, nothing else (dispatch 000267, freeze 1B)
