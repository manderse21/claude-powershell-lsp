...
| --- | --- |
| **RE-OPEN T6.1 -- the capture default (R-A)** | **Ruled (a)**, 2026-09-05, as **R8**, ratified by acceptance of the 000279 inbox: *"Re-open T6.1 narrowly: a metadata-only capture mode on the POWERSHELL_LSP_* admin env surface, T6.1 amended to record the management-plane reader the review named (EDR, backup, eDiscovery, DLP). NOT built tonight -- chartered for night 4, because the capture's consumer set deserves its own derivation."* The slice is [`ENTERPRISE-PROGRAM-DOCKET.md`](ENTERPRISE-PROGRAM-DOCKET.md) P0-2, unbuilt, and `THREAT-MODEL.md` T6.1 is still unamended -- both belong to the chartered night, not to this row |
