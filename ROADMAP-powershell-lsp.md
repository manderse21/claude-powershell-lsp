...
current v1.25.0 was cut end-to-end by it (verified-from-web: the v1.24.1/v1.24.2/v1.24.3 and v1.25.0
tags are all `github-actions[bot]`-tagged from the release runner, never a local tag):
